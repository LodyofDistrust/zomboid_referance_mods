...
----------------------things you can use to change zombies -----------------------
--[[
Speed (1 is sprinters (fastest), 2 is fast shamblers, 3 is shamblers (slowest), 4 is random)
Strength (1 is superhuman, 2 is normal, 3 is weak)
Toughness (1 is tough, 2 is normal, 3 is fragile)
Cognition (How smart zombies are. 1 is Navigate/Use Doors, 3 is basic navigation only)
Memory (How much zombies will remember. 1 is long, 4 is none)
Sight (How well zombies can see. 1 is eagle-eyed, 3 is poor)
Hearing (How well zombies can hear. 1 is pinpoint, 3 is poor)
Smell (How well zombies can smell. 1 is bloodhound, 3 is poor)

		getSandboxOptions():set("ZombieLore.Speed",nightSpeed);
		getSandboxOptions():set("ZombieLore.Strength",nightStrength);
		getSandboxOptions():set("ZombieLore.Toughness",nightToughness);
		getSandboxOptions():set("ZombieLore.Cognition",nightCognition);
		getSandboxOptions():set("ZombieLore.Memory",nightMemory);
		getSandboxOptions():set("ZombieLore.Sight",nightSight);
		getSandboxOptions():set("ZombieLore.Hearing",nightHearing);
		getSandboxOptions():set("ZombieLore.Smell",nightSmell);
...
------------------nighttime modifications go here ----------------
...
------------------------------------------------------------------
   ...
   elseif hour >= 6.0 and hour <= 23.0 and vMod.SummerFastShamblerCheck ~= true and NS.config.rainsprinters == true and rain < rv or hour >= 6.0 and hour <= 23.0 and vMod.SummerFastShamblerCheck ~= true and NS.config.rainsprinters == false then
		if minute == 2 or minute == 4 or minute == 6 or minute == 8 or minute == 10 or minute == 12 or minute == 14 or minute == 16 or minute == 18 or minute == 20 or minute == 22 or minute == 24 or minute == 26 or minute == 28 or minute == 30 or minute == 32 or minute == 34 or minute == 36 or minute == 38 or minute == 40 or minute == 42 or minute == 44 or minute == 46 or minute == 48 or minute == 50 or minute == 52 or minute == 54 or minute == 56 or minute == 58 or minute == 60 then
------------------daytime modifications go here ----------------
		getSandboxOptions():set("ZombieLore.Cognition",2);
